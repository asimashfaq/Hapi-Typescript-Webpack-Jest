...
describe('EnvironmentConfig', () => {
    ...
    it('returns "debug" if process.env.LOG_LEVEL is not set', () => {
        const expected: string = 'debug'
    ...
    it('returns "learnimpact" if process.env.APP_NAME is not set', () => {
        const expected: string = 'learnimpact'
